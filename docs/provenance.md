...
[资料来源与范围](../.project-wiki/decisions/project-scope.md)记录来源、获取状态和确认边界；
[知识索引](../.project-wiki/index.md)按任务引导到对应主题。
...
| Wiki 主题、索引、日志、规范 | 详细需求与来源记录在主题页，索引只保留路由，日志用于追溯；原文仍按字节保留 |
